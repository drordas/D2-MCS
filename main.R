...
cluster.subset <- readRDS(file = file.path(getwd(),"datasets/BinaryFisherCluster","clustering.rds") )
train.subset <- readRDS(file = file.path(getwd(),"datasets/BinaryFisherCluster","train.rds") )
test.subset <- readRDS(file = file.path(getwd(),"datasets/BinaryFisherCluster","test.rds") )
